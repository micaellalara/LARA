...
<head>
    ...
    <link href="/lara/landing/adminpage/assets/css/sb-admin-2.css" rel="stylesheet">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="/lara/landing/adminpage/messages.php">Show All Announcements</a>
                            </div>
                        </li>
